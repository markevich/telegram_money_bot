defmodule TelegramMoneyBot.Pipelines.Limits.CallbacksTest do
  ...
  describe "#{@limits_stats_callback} callback" do
    ...
    defmock TelegramMoneyBot.Steps.Limits.RenderLimitsStats do
      def call(_) do
        :passthrough
      end
    end
