defmodule MarkevichMoney.Release do
  ...
  def changelog("1.0.2") do
    ...
    *14 Декабря 2020*
    Новое:
      *- Добавлен новый график "Категории с наибольшим количество транзакций".
      *- Добавлен новый график "Категории с наибольшими тратами (BYN)". Новые графики можно изучить на сайте [https://markevich.money](https://markevich.money).
