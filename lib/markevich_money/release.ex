defmodule MarkevichMoney.Release do
  ...
  def changelog("1.0") do
    ...
    *25 Сентября 2020*
    ...
    Технический релиз - это всегда скучно, поэтому добавлю немного фактов о проекте:
      - Первая строчка кода была написана *17 сентября 2019*;
      - Первый релиз на продакшн - *2 января 2020*;
      - Общее количество версий (обновлений) - *143*;
      - Количество активных пользователей - *5*;
      - Количество созданных транзакций - *~1650*;
      - Сумма всех транзакций - *~123500 BYN*;
      - Самые часто используемые категории - *"Еда" (40%), "Транспорт" (24%), "Развлечения" (12%)*;
      - Категории с наибольшими суммарными тратами - *"Дом" (42%), "Еда" (11%), "Транспорт" (10%)*.

    Проект создан и поддерживается одним человеком, и этот человек не откажется от вашей помощи :)
      - Боту нужны пользователи, а автору нужна мотивация. Пожалуйста, расскажите своим друзьям про проект. Каждый новый пользователь - это огромный шаг вперед;
      - Вам нравится или не нравится определенный функционал - пожалуйста, расскажите об этом. Крутые фичи будут развиваться дальше, а никому не нужные - удаляться;
      - Чего-то не хватает? Пожалуйста, не молчите. Как бы это удивительно ни звучало - проект с одним разработчиком гораздо более гибкий и может подстраиваться под нужды пользователей за считанные часы.

    Контакты автора:
    Telegram: [Слава Маркевич](t.me/mr_markevich)
    Email: slava.markevich@gmail.com
    Телефон: +375291153072
    """
  end
